...
<div class="row">
  <div class="col-md-12">
      ...
      <form class="form-horizontal" role="form" action="<?php _e(BASE_URL . "jobs/{$job->id}/publish/{$job->token}"); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
        <label for="salary" class="col-sm-3 control-label input-lg"><?php echo $lang->t('jobs|salary'); ?></label>
            <div class="col-sm-8">
              <textarea required id="salary" name="salary" class="form-control input-lg" rows="2"><?php _e($job->salary, 'input'); ?></textarea>
            </div>
        </div> 
          
        <div class="form-group">
        <label for="impact" class="col-sm-3 control-label input-lg"><?php echo $lang->t('jobs|impact'); ?></label>
            <div class="col-sm-8">
              <textarea id="impact" name="impact" class="form-control input-lg" rows="2"><?php _e($job->impact, 'input'); ?></textarea>
            </div>
        </div>
        
        <div class="form-group">
        <label for="impact" class="col-sm-3 control-label input-lg"><?php echo $lang->t('jobs|perks'); ?></label>
            <div class="col-sm-8">
